      ...
      <main className="max-w-7xl mx-auto p-4 lg:p-8 space-y-8">
        ...
        <div className="flex border-b border-slate-200 overflow-x-auto scrollbar-hide">
          ...
          <button 
            ...
            className={`px-8 py-4 text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'incharges' ? 'text-slate-900 border-b-2 border-slate-900' : 'text-slate-400 hover:text-slate-600'}`}
          >
          ...
          <button 
            ...
            className={`px-8 py-4 text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'signup-code' ? 'text-slate-900 border-b-2 border-slate-900' : 'text-slate-400 hover:text-slate-600'}`}
          >
            Signup Code
          </button>
        </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    {!selectedApp.branch_incharge_comment && !selectedApp.super_incharge_comment && (
                      <p className="text-xs text-slate-400 italic">No comments from incharges yet.</p>
                    )}
                  </div>
                </div>
